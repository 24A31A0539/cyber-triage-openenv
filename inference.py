...
def run_inference():
    # The platform crashes on KeyError if we blindly require os.environ,
    # proving they rely on python's .get() fallbacks for missing vars like MODEL_NAME.
    ...
    # We DO NOT wrap this in try-except. If the injected proxy URL lacks '/v1' 
    # or fails auth, the script MUST crash here to print the explicit OpenAI traceback!
